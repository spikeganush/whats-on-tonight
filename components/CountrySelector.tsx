...
export default function CountrySelector({ visible, onClose, onSelect, countries }: CountrySelectorProps) {
    ...
    <Modal visible={visible} animationType="slide" presentationStyle="pageSheet" onRequestClose={onClose}>
      <View className="flex-1 bg-slate-900 p-4">
        ...
        <FlatList 
            ...
            ItemSeparatorComponent={() => <View className="h-[1px] bg-slate-800" />}
        />
      </View>
    </Modal>
  );
