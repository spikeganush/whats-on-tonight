  ...
  if (!movie) {
    return (
      <View className="flex-1 bg-slate-900 items-center justify-center p-6">
        <Text className="text-green-500 font-bold text-4xl mb-8">
          It's a Match!
        </Text>
        ...
        >
          <Text className="text-white">
            If this takes too long, check your internet or API key.
          </Text>
        </TouchableOpacity>
      </View>
    );
  ...
  return (
    <View className="flex-1 bg-slate-900 items-center justify-center p-6 w-full">
      ...
      <TouchableOpacity
        ...
        className="bg-slate-800 p-4 rounded-2xl items-center shadow-lg w-full max-w-sm"
      >
        <Image
          source={{
        ...
        <Text className="text-slate-400 text-center mb-4" numberOfLines={3}>
          {movie.overview}
        </Text>
